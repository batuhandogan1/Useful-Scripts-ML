...
class Config(MyConfig):
    def __init__(self):
        ...
        self.miscs.eval_interval_epochs = 6000
        ...
        self.dataset.val_ann = ('coco_test', )
	    
        #self.train.finetune_path = '/media/ekin/Media7/Batuhan_Dogan/Vehicle_Type/DAMO-YOLO/damoyolo_tinynasL25_S_477.pth'
